 ...
 */
final class Version20221031230955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD createda_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, ADD slug VARCHAR(255) NOT NULL, DROP created_at');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP createda_at, DROP slug');
